...
<?php
    ...
    if($titre==NULL || $texte==NULL ){
        ...
        $sql="INSERT INTO `t_actualite_act` (`act_num`, `act_titre`, `act_text`, `act_date`, `cpt_pseudo`) VALUES (NULL, '" .addslashes($titre). "', '" .addslashes($texte). "', NOW() , '$pseudo');";            # on ajoute une ligne dans la table des actualités
