...
<?php
    ...
    $mysqli = new mysqli('localhost','zmenouch0','b7h5scjf','zfl2-zmenouch0');             # connexion à la base données
    ...
    if($nom==NULL || $prenom==NULL || $email==NULL || $texte==NULL ){
        echo "<center>";
        echo "<br />";
        echo "<br />";
        echo "<br />";
        ...
        echo "<br />";
        echo "<br />";
        echo("<a href='./admin_exposant.php'>Recommencer</a>");
        echo "</h4>";
        echo "</center>";
    }else{
        $sql="INSERT INTO `t_exposant_exp` (`exp_id`, `exp_nom`, `exp_prenom`, `exp_texte`, `exp_e_mail`, `cpt_pseudo`) VALUES (NULL, '" .addslashes($nom). "', '$prenom', '" .addslashes($texte). "','$email','$pseudo');";         # ajout d'un exposant
